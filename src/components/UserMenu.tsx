...
export const UserMenu: React.FC = () => {
  ...
  const menuPanel = (
    <>
      ...
      {/* 菜单面板 */}
      <div className='app-user-menu fixed top-14 right-4 w-56 bg-white dark:bg-gray-900 rounded-lg shadow-xl z-[1001] border border-gray-200/50 dark:border-gray-700/50 overflow-hidden select-none'>
        {/* 用户信息区域 */}
        ...
        <div className='py-1'>
          ...
          <button
            ...
            className='app-user-menu-item w-full px-3 py-2 text-left flex items-center gap-2.5 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-sm'
          >
          ...
          <button
            ...
            className='app-user-menu-item w-full px-3 py-2 text-left flex items-center gap-2.5 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors text-sm'
          >
